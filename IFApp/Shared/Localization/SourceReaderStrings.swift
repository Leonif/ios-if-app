...
enum SourceReaderStrings {
    ...
    static var two_body: String { String(localized: "SourceReader.2.body", defaultValue: "One year, 100 obese adults on alternate-day fasting - a different schedule from a daily 16:8 window. On average weight fell 6.0% on the fasting days plan and 5.3% on daily calorie cutting - no real difference. More quit the fasting arm (38% vs 29%), and their \"bad\" cholesterol ran higher.") }
