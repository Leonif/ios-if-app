...
**computer-use для тапов не использовать.** Кликать по окну симулятора мышкой не нужно: это лезет на рабочий стол владельца, ломается от размера окна и не воспроизводится.
